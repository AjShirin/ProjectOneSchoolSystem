...
public class Nationalities {
	public void showNationalities() throws IOException, InterruptedException {
		System.out.println("Please enter nationaltiy ");
		Scanner sc = new Scanner(System.in);
		String natial = sc.next();

		HttpClient client = HttpClient.newHttpClient();
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create("https://randomuser.me/api/?nat=" + natial + "")).build();
